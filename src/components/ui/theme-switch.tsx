...
export default function ThemeSwitcher() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed top-2     right-2 z-50 w-10 h-10 rounded-full backdrop-blur-md bg-white/15 dark:bg-black/15 border border-white/25 dark:border-white/10 flex items-center justify-center transition-all duration-300 hover:bg-white/25 dark:hover:bg-black/25 group"
